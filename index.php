            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-md-block">
                        ...
                        <p>
                        Somos la mejor Barberia de la ciudad de La Paz
                            <br>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="about_content" style="text-align: center;">
                    ...
                    <h2>Somos tu Barberia Favorita <br>Desde 2024</h2>
                    <img src="Design/images/about-logo.png" alt="logo">
                    <p style="color: #777">
                        Somos una peluquería enfocada en nuestros clientes. antes de empezar 
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 padd_col_res">
                <div class="service_box">
                    ...
                    <p>Los mejores cortes de cabellos a pedido del cliente</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 padd_col_res">
                <div class="service_box">
                            ...
                            <ul class="price_list">
                                ...
                                ?>
                                    ...
                                    <li>
                                        ...
                                        <span class="price">Bs. <?php echo $service['service_price'] ?></span>
                                    </li>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer_widget">
                    ...
                    <ul class="opening_time">
                        <li>Lunes - Viernes 10:00 am - 18:00 pm</li>
                        <li>Lunes - Viernes 11:30 am - 18:00 pm</li>
                        <li>Lunes - Viernes 11:30 am - 18:00 pm</li>
                        <li>Lunes - Viernes 11:30 am - 18:00 pm</li>
                    </ul>
                </div>
